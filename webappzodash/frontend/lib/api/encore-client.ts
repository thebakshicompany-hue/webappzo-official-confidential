...
export function Environment(name: string): BaseURL {
  return `https://${name}-webappzodash-stui.encr.app`;
}
...
/**
 * Client is an API client for the webappzodash-stui Encore application.
 */
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    if (typeof window === "undefined") {
      this.headers["User-Agent"] =
        "webappzodash-stui-Generated-TS-Client (Encore/v1.46.5)";
    }
